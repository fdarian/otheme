...
| --- | --- | --- |
| 1 | `~/.config/otheme/generated/nvim.lua` | write generated Neovim colorscheme (overwritten in place on every `set`) |
...
| 2 | `nvim --server '<socket>' --remote-expr 'luafile("~/.config/otheme/generated/nvim.lua")'` | live-apply the generated colorscheme to each running Neovim socket |
