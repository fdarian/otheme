...
# farreldarian/homebrew-tap (i.e. github.com/farreldarian/homebrew-tap).
# Drop it at Formula/otheme.rb in that repo.
#
# ASSUMPTIONS:
# - The tap repo exists at github.com/farreldarian/homebrew-tap.
# - The otheme package has been published to npm at least once under the
#   name `otheme` before users can `brew install farreldarian/tap/otheme`.
...
#   4. Commit and push to farreldarian/homebrew-tap.

class Otheme < Formula
  desc "Apply shared themes across editor and terminal targets"
  homepage "https://otheme.farreldarian.com"
